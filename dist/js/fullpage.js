...
// //helper function
// const activeSecttionHandeler = (currentSectionId) => {
//    console.log(currentSectionId);
//    navbtns.forEach(btnLink => {
//       if (btnLink.dataset.section === currentSectionId) {
...
// // interrsection observer
// const sectionViewerCallback = (section, sectionViewer) => {
//    section.forEach(section => {
//       if (!section.isIntersecting) { return }
//       activeSecttionHandeler(section.target.id);
//    })
// }

// const sectionViewerOptions = {
//    threshold: .8
// }

// const sectionViewer = new IntersectionObserver(sectionViewerCallback, sectionViewerOptions);
// sectoins.forEach(section => {
//    sectionViewer.observe(section);
// })
